...
function App() {
  ...
  return (
    <main className="container flex flex-col items-center justify-center w-full h-screen gap-4 pb-4">
      ...
      <div className="flex flex-col flex-1 w-full h-full gap-8 p-5 border rounded-lg lg:p-16 bg-neutral-100/30">
        ...
        <div className="flex flex-col w-full gap-12">
          <div className="flex flex-col items-center justify-between gap-3 md:flex-row">
            ...
            >
              ...
              <SelectContent className="w-[300px] max-w-[calc(100vw-24px)]">
                <SelectItem value="decision_trees">Decision Trees</SelectItem>
          ...
          <div className="flex items-center justify-center w-full min-h-24 md:min-h-80">
            <Button
